import type { Feature, FeatureCollection, StopDraggingEvent, PointerMoveEvent, Position } from '@nebula.gl/edit-modes';
import { ModeProps } from '../types';
import { GEOJSON_TYPE, GUIDE_TYPE } from '../constants';
import BaseMode from './base-mode';
export default class EditingMode extends BaseMode {
    handleClick: (event: import("@nebula.gl/edit-modes/dist-types/types").BasePointerEvent, props: ModeProps<FeatureCollection>) => void;
